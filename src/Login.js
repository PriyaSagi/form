   ...
   <div className="name" style={{"height":"490px", "width":"70%", "margin-left":"100px"}}>
    ...
    <div className="formpage" style={{"height":"370px", "background-color":"rgba(255, 255, 255, 0.932)"}}>
        <form action="/action_page.php" style={{"margin-left":"30px"}}>
            ...
            <button type="button" className="btn btn-primary btn-lg" style={{"margin-top":"10px", "margin-left":"10px"}}>Login</button>
            <a href="/"><button type="button" className="btn btn-primary btn-lg" style={{"margin-top":"10px", "margin-left":"10px"}}>Sign Up!</button></a>
